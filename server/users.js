...
router.post('/', async (req, res) => {
  console.log("Inside the users.js");
  if (!req.body.username || !req.body.password || !req.body.name || !req.body.childName)
    return res.status(400).send({
      message: "Name, child's name, username, and password are required."
    });
